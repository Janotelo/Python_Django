...
SECRET_KEY = 'django-insecure-=n016k2j8o7j)l%u$36un!-p3ecv)%7n4m+@f$m1@!5m4*m831'
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles', # rechecked if included for CSS Static Files
]
